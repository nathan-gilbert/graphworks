#Nathan Gilbert
#A class to handle the various algorithms stated to be implemented. 
#Defines the core graph theoretic functionality of graphworks. 
...
class FunctionHandler:
	...
	def path(self, start, end, path=[]):
		...
		if start == end:
			return path
		if not self.GRAPH.adj.has_key(start):
			return None
